...
<div class="container">
    ...
    <form class="col-lg-8" method="POST" action="{{route('books.store')}}">
        ...
        <div class="form-group">
            ...
            <input class="form-control @error('title') border-danger @enderror" type="text" name="title" id="title" placeholder="Title" value="{{$title}}">
            @error('title')
        ...
        <div class="form-group">
            ...
            <input class="form-control @error('author') border-danger @enderror" type="text" name="author" id="author" placeholder="Author" value="{{$author}}">
            @error('author')
