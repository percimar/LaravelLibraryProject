...
<div class="container">
    ...
    <form class="col-lg-8" method="POST" action="{{route('books.store')}}">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('isbn') border-danger @enderror"
            name="isbn"
            id="isbn"
            placeholder="ISBN"
            value="{{old('isbn')}}">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('pages') border-danger @enderror"
            name="pages"
            id="pages"
        ...
        <div class="form-group">
            ...
            <input 
            class="form-control @error('publication') border-danger @enderror"
            type="date" 
            name="publication"
            id="publication"
